...
import com.example.hp.md.adapter.AdapterInMain;
import com.example.hp.md.base.BaseActivity;
...
public class MainActivity extends BaseActivity {
    ...
    private void initRecyclerView() {
        ...
        mRV.setAdapter(new AdapterInMain(mImgUrls, this));
    }

    private void findViews() {
        mRV = (RecyclerView) findViewById(R.id.recyclerView_garry);
